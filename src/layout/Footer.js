export const Footer = () => {
    return (
        <div id="footer" className="bg-gray-900 w-full flex flex-col">
            <a href="#" className="bg-webmotors-red w-full p-3">
                <div className="bg-transparent text-center text-white gap-3 text-sm">
                    <span>Nossos canais de atendimento são 100% digitais. Precisa de ajuda? </span>
                    <strong>Clique aqui!</strong>
                </div>
            </a>

            <div className="bg-gray-900 flex flex-row mx-auto justify-center text-center gap-2 mt-14 mb-14" >
                <div className="w-60 text-white">
                    <div id="title-footer" className="font-bold text-xl text-left mb-10">
                        <h1>Comprar</h1>
                    </div>
                    <div className="flex flex-col items-start gap-2">
                        ...
                        <a href="#">Vistoriador</a>
                    </div>

                    <div id="title-footer" className="font-bold text-xl text-left mt-8 mb-8">
                        <h1>Vender</h1>
                    </div>
                    <div className="flex flex-col items-start gap-2">
                ...
                <div className="w-60 text-white">
                    ...
                    <div className="flex flex-col items-start text-left gap-2">
                        ...
                        <a href="#">Código de conduta da webmotors</a>
